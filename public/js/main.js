...
registerGlobals({
  ...
  updateAddCmdThresholdPathFilter:
    CommandManager.updateAddCmdThresholdPathFilter,
  toggleAddCmdThresholdValueField:
    CommandManager.toggleAddCmdThresholdValueField,
  ...
  meSelectContext: MapExplorer.selectContext,
  meFilterContexts: MapExplorer.filterContexts,
